...
class penerbit_model extends CI_Model
{
    ...
    var $column_order = array(null, 'penerbit');

    //field yang diizin untuk pencarian 
    var $column_search = array('penerbit');

    //field pertama yang diurutkan
    var $order = array('penerbit' => 'asc');
    ...
    public function read()
    {
        ...
        //sql read
        $this->db->select('*');
        $this->db->from('penerbit a');
        $this->db->order_by('a.penerbit ASC');
        $query = $this->db->get();
    ...
    public function read_check($penerbit)
    {
        $this->db->select('*');
